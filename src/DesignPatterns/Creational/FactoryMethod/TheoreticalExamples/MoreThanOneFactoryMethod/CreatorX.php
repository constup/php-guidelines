...
class CreatorX implements CreatorInterface
{
     ...
     * purpose is implemented in the operationX() method which merely uses the objects produced by factory methods in
    ...
    {
        $product = $this->factoryMethod1('test string value', 1);
