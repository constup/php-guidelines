...
namespace App\DesignPatterns\Creational\AbstractFactory\Alternatives\ServiceBundle\NewSubFamily\Family\OperatingSystem\Service\Factory\Linux\DesktopEnvironment;
...
class KDEFactory implements FamilyFactoryInterface
{
    public function produceButton(
        ...
        return new Button($label, $height, $width, $theme, 'linux', 'kde');
    }
    ...
    public function produceCheckbox(
        ...
        return new Checkbox($label, $theme, $enabled, 'linux', 'kde');
    }
}
