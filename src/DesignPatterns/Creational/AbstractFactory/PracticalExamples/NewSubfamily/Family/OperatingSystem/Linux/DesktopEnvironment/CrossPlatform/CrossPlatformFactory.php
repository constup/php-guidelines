...
namespace App\DesignPatterns\Creational\AbstractFactory\PracticalExamples\NewSubfamily\Family\OperatingSystem\Linux\DesktopEnvironment\CrossPlatform;
...
class CrossPlatformFactory implements AbstractFactory
{
    public function produceButton(
        ...
        return new CrossPlatformButton($label, $height, $width, $theme, 'linux', 'crossplatform');
    }
    ...
    public function produceCheckbox(
        ...
        return new CrossPlatformCheckbox($label, $theme, $enabled, 'linux', 'crossplatform');
    }
}
