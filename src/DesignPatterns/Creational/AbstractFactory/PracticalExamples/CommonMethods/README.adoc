...
is deeply rooted in code's architecture and is simply not flexible enough. Service Bundle, on the other hand, does not
have any issues with common services and service methods which are not tied to family classification.
